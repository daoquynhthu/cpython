...
* :ref:`PyVault security isolation <whatsnew314-pyvault>`
...
.. _whatsnew314-pyvault:

PyVault security isolation
--------------------------

PyVault adds a color-based isolation model for objects and code execution.
Each thread has an active color, and objects, code objects, and modules can be
tagged with a security color. Attribute access across mismatched colors raises
``PermissionError``. Module sealing recursively tags module members to enforce
access control.

The new APIs are exposed on :mod:`sys`: :func:`sys.set_color`,
:func:`sys.get_color`, :func:`sys.set_obj_tag`, :func:`sys.get_obj_tag`,
:func:`sys.set_code_color`, :func:`sys.get_code_color`, and :func:`sys.seal`.
